...
const file_meshtastic_telemetry_proto_rawDesc = "" +
	...
	"\x10soil_temperature\x18\x16 \x01(\x02H\x15R\x0fsoilTemperature\x88\x01\x01\x124\n" +
	"\x14one_wire_temperature\x18\x17 \x03(\x02B\x02\x18\x01R\x12oneWireTemperature\x12+\n" +
	"\x0fadc_voltage_ch0\x18\x18 \x01(\x02H\x16R\radcVoltageCh0\x88\x01\x01\x12+\n" +
	"\x0fadc_voltage_ch1\x18\x19 \x01(\x02H\x17R\radcVoltageCh1\x88\x01\x01\x12+\n" +
	"\x0fadc_voltage_ch2\x18\x1a \x01(\x02H\x18R\radcVoltageCh2\x88\x01\x01\x12+\n" +
	"\x0fadc_voltage_ch3\x18\x1b \x01(\x02H\x19R\radcVoltageCh3\x88\x01\x01\x12+\n" +
	"\x0fadc_voltage_ch4\x18\x1c \x01(\x02H\x1aR\radcVoltageCh4\x88\x01\x01\x12+\n" +
	"\x0fadc_voltage_ch5\x18\x1d \x01(\x02H\x1bR\radcVoltageCh5\x88\x01\x01\x12+\n" +
	"\x0fadc_voltage_ch6\x18\x1e \x01(\x02H\x1cR\radcVoltageCh6\x88\x01\x01\x12+\n" +
	"\x0fadc_voltage_ch7\x18\x1f \x01(\x02H\x1dR\radcVoltageCh7\x88\x01\x01\x12<\n" +
	"\x18one_wire_temperature_ch0\x18  \x01(\x02H\x1eR\x15oneWireTemperatureCh0\x88\x01\x01\x12<\n" +
	"\x18one_wire_temperature_ch1\x18! \x01(\x02H\x1fR\x15oneWireTemperatureCh1\x88\x01\x01\x12<\n" +
	"\x18one_wire_temperature_ch2\x18\" \x01(\x02H R\x15oneWireTemperatureCh2\x88\x01\x01\x12<\n" +
	"\x18one_wire_temperature_ch3\x18# \x01(\x02H!R\x15oneWireTemperatureCh3\x88\x01\x01\x12<\n" +
	...
	"\x15lightning_distance_km\x18) \x01(\x02H'R\x13lightningDistanceKm\x88\x01\x01B\x0e\n" +
	"\f_temperatureB\x14\n" +
	...
	"\x16_lightning_distance_km\"\x96\a\n" +
	"\fPowerMetrics\x12$\n" +
	...
	"\vch4_voltage\x18\a \x01(\x02B\x02\x18\x01H\x06R\n" +
	"ch4Voltage\x88\x01\x01\x12(\n" +
	"\vch4_current\x18\b \x01(\x02B\x02\x18\x01H\aR\n" +
	"ch4Current\x88\x01\x01\x12(\n" +
	"\vch5_voltage\x18\t \x01(\x02B\x02\x18\x01H\bR\n" +
	"ch5Voltage\x88\x01\x01\x12(\n" +
	"\vch5_current\x18\n" +
	" \x01(\x02B\x02\x18\x01H\tR\n" +
	"ch5Current\x88\x01\x01\x12(\n" +
	"\vch6_voltage\x18\v \x01(\x02B\x02\x18\x01H\n" +
	"R\n" +
	"ch6Voltage\x88\x01\x01\x12(\n" +
	"\vch6_current\x18\f \x01(\x02B\x02\x18\x01H\vR\n" +
	"ch6Current\x88\x01\x01\x12(\n" +
	"\vch7_voltage\x18\r \x01(\x02B\x02\x18\x01H\fR\n" +
	"ch7Voltage\x88\x01\x01\x12(\n" +
	"\vch7_current\x18\x0e \x01(\x02B\x02\x18\x01H\rR\n" +
	"ch7Current\x88\x01\x01\x12(\n" +
	"\vch8_voltage\x18\x0f \x01(\x02B\x02\x18\x01H\x0eR\n" +
	"ch8Voltage\x88\x01\x01\x12(\n" +
	"\vch8_current\x18\x10 \x01(\x02B\x02\x18\x01H\x0fR\n" +
	...
	"\rparticles_tps\x18\x19 \x01(\x02H\x18R\fparticlesTps\x88\x01\x01\x12+\n" +
	"\x0fpm_status_flags\x18\x1a \x01(\rH\x19R\rpmStatusFlags\x88\x01\x01B\x10\n" +
	...
	"\x06BH1750\x10-\x12\v\n" +
	"\aHDC1080\x10.\x12\r\n" +
	"\x05SHT21\x10/\x1a\x02\b\x01\x12\t\n" +
	"\x05STC31\x100\x12\t\n" +
	"\x05SCD30\x101\x12\t\n" +
	"\x05SHTXX\x102\x12\n" +
	"\n" +
